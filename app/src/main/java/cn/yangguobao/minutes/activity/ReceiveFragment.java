...
public class ReceiveFragment extends Fragment implements OnGetGeoCoderResultListener {
...
//                                android.widget.RatingBar ratingBar = (android.widget.RatingBar) getView().findViewById(R.id.orderDetailRatingBar);
...
//
//                                cusName =(TextView) getActivity().findViewById(R.id.orderDetailUserNickName);
//
//                                cusPhone=(TextView) getActivity().findViewById(R.id.new_order_tel);
//
...
//                                cusPhone.setText(data.getString("fromTel"));
                                ...
                                mSearch.setOnGetGeoCodeResultListener(ReceiveFragment.this);//todo


                                startOrder=(Button) getActivity().findViewById(R.id.startOrderNow);
                                cancelOrder=(Button)getActivity().findViewById(R.id.cancelOrderNow);
                                sendToCus=(ImageView) getActivity().findViewById(R.id.to_msg);
                                callToCus=(ImageView) getActivity().findViewById(R.id.to_dial);
        ...
        Http.post("order/start", params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                if (statusCode == 200) {
                    try {
                        if (response.getInt("code") == 200) {
                            Toast.makeText(getActivity(), "订单成功开始！",
...
//todo                这里要让它重启自己的活动
                ...
                Toast.makeText(getActivity(), jb.getString("message"),
                        Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        if (httpResponse.getStatusLine().getStatusCode() == 200) {
                            ...
                            if(jb.getString("code").equals("200")){
                                ...
                                Toast.makeText(getActivity(), jb.getString("message"), Toast.LENGTH_LONG)
                                        .show();
                            }
